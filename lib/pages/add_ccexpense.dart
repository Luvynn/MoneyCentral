    ...
    return Card(
      ...
      child: MaterialButton(
        ...
        onPressed: () async {
          ...
          if (pickedDate != null) {
            setState(() {
              _formData["createdAt"] = pickedDate.millisecondsSinceEpoch;
            });
          }
        },
      ),
  ...
  _buildCreditCardNameField() {
    return Card(
      ...
      child: TextFormField(
        ...
        onSaved: (value) => _formData["creditCardName"] = value?? '',
        decoration: InputDecoration(
          contentPadding: EdgeInsets.symmetric(
            horizontal: 20.0,
            vertical: 20.0,
      ...
      child: MaterialButton(
        onPressed: () {
          if (_formKey.currentState?.validate() ?? false) {
            ...
            // Assuming addCCExpense has been correctly defined elsewhere to accept these parameters
            addCCExpense(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            SizedBox(width: 10),
            Text("Save Expense", style: TextStyle(color: Colors.white)),
          ],
        ),
      ),
    );
